...
6. **Phase 2：交稿前自检与收束**
   ...
   - 6.9 **结构呼吸感检查**：若章节达到 1000 字以上，优先确认至少有一处功能性停留（环境闲描 / 角色闲聊 / 感官片段 / 回忆碎片 / 生活细节）；检查高压场景后是否留出 1-2 句过渡。若是连续高压章节不适合明显停留，也至少检查段尾是否留出 1-2 句过渡。另查对话是否全部变成“任务执行”式推进，必要时补入最小必要的闲笔或缓冲
