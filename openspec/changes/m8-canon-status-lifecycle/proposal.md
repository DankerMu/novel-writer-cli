...
- 修改 3 个 Agent prompt（`agents/world-builder.md`、`agents/character-weaver.md`、`agents/chapter-writer.md`）
- 修改 1 个 Agent prompt（`agents/quality-judge.md`）
- 修改 1 个 Skill（`skills/continue/SKILL.md`）
- 不新增运行时文件或依赖
